...
class _$_RegisterState implements _RegisterState {
  ...
  @override
  String toString() {
    return 'RegisterState(email: $email, password: $password, vpassword: $vpassword, name: $name, termsOk: $termsOk)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, email, password, vpassword, name, termsOk);
